...
include "../func/adminHandler.php";

$admin = getAdmin($_SESSION['user_id']);
...
<div class="container my-5 ml-2 flex-shrink-1 p-3">
        ...
        <div class="col-md-12">
            <div class="align-items-baseline d-flex justify-content-between">
                ...
                <div class="d-flex align-items-baseline">
                    ...
                    <p class="ml-1 text-muted">/ Admin profile</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-4 rounded">
        ...
        <div class="upload position-relative">
            ...
            <?php else: ?>
            <img src="<?=$admin['image']?>" alt="hugenerd" width="120" height="120" class="rounded-circle" style="border: 4px solid #00b4ff;">
            <?php endif; ?>
            <div class="round">
        ...
        <form action="admin.php" method="post">
            <div class="mt-3 text-dark">
                <div class="form-group">
                    ...
                    <input type="text" name="Fname" class="form-control rounded-0" value="<?=$admin['Fname']?>">
                </div>
                <div class="form-group">
                    <label for="Lname">Admin last name</label>
                    <input type="text" name="Lname" class="form-control rounded-0" value="<?=$admin['Lname']?>">
                </div>
                <div class="form-group">
                    <label for="DoB">Admin Date of Birth</label>
                    <input type="date" name="DoB" class="form-control rounded-0"
                        value="<?=substr($admin['DoB'],0,10)?>">
                </div>
                <div class="form-group">
                    <label for="phoneNum">Contact number</label>
                    <input type="text" name="phoneNum" class="form-control rounded-0" value="<?=$admin['phone_num']?>">
                </div>
                <div class="form-group">
                    <label for="register">Admin Registration Date</label>
                    <input type="text" name="register" class="form-control rounded-0"
                        value="<?=$admin['date_created']?>" readonly required>
                </div>
                <?php if($admin['gender'] == 0):?>
