                ...
                <ul class="navbar-nav ml-auto" style="margin: 0px 25px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-light">
                            ...
                            <li class="text-center">
                                <p class="dropdown-item" style="font-size: 12px;color: #646566;"><?=$_SESSION['email']?>
                                </p>
                            </li>
                            <li><a class="dropdown-item" href="teacher.php"><i class="fa-regular fa-user mr-2"></i>My
                                    Profile</a></li>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start hidden-menu-horizontal"
                        ...
                        <li class="nav-item border-bottom">
                            ...
                            <ul class="collapse nav flex-column ms-1" id="Submenu5" data-bs-parent="#menu1">
                                <li class="w-100">
                                    <a href="teacher.php" class="nav-link px-0"> <span
            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item d-flex align-items-center justify-content-between pb-3 mt-3">
                        <a href="teacher.php" class="d-flex align-items-center text-white text-decoration-none">
                            <?php if($_SESSION['image'] == ""):?>
                            <img src="../../images/user.png" alt="hugenerd" width="40" height="40"
                    ...
                    <li class="nav-item border-bottom">
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-middle"><span
                                    class="ms-1 d-none d-sm-inline text-white">Homework</span></a>
                            <i class="text-success fa-solid fa-users"></i>
                        </div>
                        <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="addHomework.php" class="nav-link px-0"> <span
                                        class="d-none d-sm-inline text-white">> Add Homework</span></a>
                            </li>
                            <li>
                                <a href="manageHomework.php" class="nav-link px-0"> <span
                                        class="d-none d-sm-inline text-white">> Manage Homework</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item border-bottom d-flex align-items-center justify-content-between">
                        <a href="viewClass.php" class="nav-link align-middle px-0">
                            <span class="ms-1 d-none d-sm-inline text-white">View Class</span>
                        </a>
                        <i class="text-success fa-solid fa-layer-group"></i>
                    </li>
                    <li class="nav-item border-bottom">
