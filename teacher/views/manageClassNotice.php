...
$classNotices = getClassNoticesByClassNameAndSection($class_name, $section);
...
<div class="container my-5 ml-2 flex-shrink-1 p-3">
    ...
    <div class="bg-white p-4 rounded">
        <div class="d-flex justify-content-between">
            <h5 class="text-center">Manage Class Notice For Class <?php echo $class_name?><?php echo $section?></h5>
            ...
            <tbody>
                ...
                <div class="modal fade" id="deleteModal<?=$i?>" tabindex="-1" aria-labelledby="deleteModalLabel<?=$i?>"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 style="max-width:350px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;" class="modal-title fs-5" id="deleteModalLabel<?=$i?>">Delete notice
                                    "<?=$notice['notice_title']?>" in class
                                    <?=$notice['class_name'] .  $notice['section']?>
                                </h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
